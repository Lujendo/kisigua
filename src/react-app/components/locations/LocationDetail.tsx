            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 sticky top-24">
              <div className="text-center mb-6">
                {location.priceType === 'paid' && location.price && (
                  <div className="text-3xl font-bold text-green-600">€{location.price}</div>
                )}
              ...
              <div className="space-y-4">
                ...
                <button className="w-full border border-gray-300 hover:bg-gray-50 px-4 py-3 rounded-lg font-medium transition-colors">
                  Save to Favorites
                </button>
              </div>
            </div>
